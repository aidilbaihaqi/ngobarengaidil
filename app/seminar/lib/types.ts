...
export type Slide =
  ...
  | (SlideBase & { layout: "intro"; title: string; items: { icon: "school" | "campus" | "medal" | "globe"; text: string }[]; body: string })
  ...
  | (SlideBase & { layout: "meme"; title: string; top: [string, string]; bottom: [string, string]; memeFile: string })
