 ...
 * whole line reflowing.
 *
 * Inherits its type from the parent, so it sits at whatever size the heading
 * around it is set to.
 */
  ...
  return (
    <span className={cn("flex flex-col items-start gap-y-2", className)}>
      ...
      <motion.span
        ...
        className="relative block w-fit overflow-hidden rounded-xl border border-gray-200 bg-white px-4 py-2 leading-[1.15] text-black shadow-sm dark:border-white/10 dark:bg-neutral-900 dark:text-white"
      >
