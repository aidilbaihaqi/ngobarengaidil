  ...
  return (
    <div className="flex items-center gap-2">
      <motion.div
        ...
        className="h-4 w-4 rounded-full border border-rule bg-gradient-to-b from-neutral-400 to-neutral-300"
      />
      <motion.div
        initial={{
          y: 0,
  ...
  return (
    <div className="flex items-center">
      <motion.div
        ...
        className="h-4 w-4 rounded-full bg-ground-deep shadow-md"
      />
      <motion.div
        initial={{
          x: 0,
        ...
        className="h-4 w-4 -translate-x-2 rounded-full bg-ground-deep shadow-md"
      />
      <motion.div
        initial={{
          x: 0,
        ...
        className="h-4 w-4 -translate-x-4 rounded-full bg-ground-deep shadow-md"
      />
    </div>
  );
};
