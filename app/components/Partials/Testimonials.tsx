  ...
  return (
    <>
      ...
      <div className="mt-10 sm:mt-14">
        <h2 className="mb-3 font-medium text-ink">Testimonials</h2>

        {/* Grid */}
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-x-3 border-y border-rule divide-y sm:divide-y-0 sm:divide-x divide-rule">
          <div className="sm:-ms-4 py-6 sm:px-4">
            {/* Review */}
            <blockquote>
              <span className="text-sm text-ink">
                Im absolutely floored by the level of care and attention to
              ...
              <footer className="mt-3">
                <div className="flex items-center gap-x-2">
                  ...
                  />
                  <div className="grow">
                    <div className="text-xs text-muted">Josh Grazioso</div>
                  </div>
                </div>
              </footer>
            </blockquote>
            ...
            <blockquote>
              ...
              <footer className="mt-3">
                <div className="flex items-center gap-x-2">
                  ...
                  />
                  <div className="grow">
                    <div className="text-xs text-muted">Nicole Grazioso</div>
                  </div>
                </div>
              </footer>
            </blockquote>
