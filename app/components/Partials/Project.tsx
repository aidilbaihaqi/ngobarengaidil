  ...
  return (
    <>
      ...
      <div className="mt-10 sm:mt-14">
        <h2 className="mb-5 font-medium text-ink">Projects</h2>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
          ...
          >
            <img
              className="w-full size-40 object-cover bg-ground-deep rounded-lg"
            ...
            <div className="absolute bottom-1 end-1 opacity-0 group-hover:opacity-100 transition">
              <div className="flex items-center gap-x-1 py-1 px-2 bg-surface border border-rule text-ink rounded-lg">
                <svg
